            ...
            <div class="dropdown-content">
              <div class="dropdown-section">
                ...
                <div class="category-grid">
                  <router-link to="/forum/movie" class="category-item">
                    <i class="category-icon icon-film"></i>
                    <span>电影</span>
                  </router-link>
                  <router-link to="/forum/tv" class="category-item">
                    <i class="category-icon icon-tv"></i>
                    <span>电视剧</span>
                  </router-link>
                  <router-link to="/forum/anime" class="category-item">
                    <i class="category-icon icon-anime"></i>
                    <span>动漫</span>
                  </router-link>
                  <router-link to="/forum/variety" class="category-item">
    ...
    <div class="mobile-menu" :class="{ show: mobileMenuOpen }">
      <div class="mobile-menu-content">
        ...
        <div class="mobile-nav">
          ...
          <router-link to="/forum" class="mobile-nav-item" @click="closeMobileMenu">
            <i class="icon-forum"></i>
            <span>论坛</span>
          </router-link>
          <router-link to="/trending" class="mobile-nav-item" @click="closeMobileMenu">
            <i class="icon-star"></i>
            <span>热门</span>
          </router-link>
        </div>
        ...
        <div class="mobile-categories">
          ...
          <div class="mobile-category-grid">
            <router-link to="/forum/movie" class="mobile-category-item" @click="closeMobileMenu">
              <i class="icon-film"></i>
              <span>电影</span>
            </router-link>
            <router-link to="/forum/tv" class="mobile-category-item" @click="closeMobileMenu">
              <i class="icon-tv"></i>
              <span>电视剧</span>
            </router-link>
            <router-link to="/forum/anime" class="mobile-category-item" @click="closeMobileMenu">
              <i class="icon-anime"></i>
              <span>动漫</span>
            </router-link>
            <router-link to="/forum/variety" class="mobile-category-item" @click="closeMobileMenu">
              <i class="icon-variety"></i>
              <span>综艺</span>
            </router-link>
          </div>
        </div>
